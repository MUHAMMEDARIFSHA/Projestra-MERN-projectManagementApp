      ...
      <Stack direction="column" marginTop="60px">
        ...
        >
          <Container>
            ...
            <Grid container justifyContent={'space-around'} sx={{ mt: 10 }}>
              <Card item sx={{ width: 350 ,cursor:'pointer' }} onClick={toProject}>
              ...
              <Card item sx={{ width: 350 ,cursor:"pointer" }} onClick={toProject}>
                ...
                <Box sx={{ maxHeight: "400px" }}>
                  ...
                  >
                    Manage a huges team,divide the
                    <br />
...
export default HomeBeforeSignIn
